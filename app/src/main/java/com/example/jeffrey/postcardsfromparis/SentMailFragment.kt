...
/**
 * This fragment displays postcards sent by the user
 */
class SentMailFragment : Fragment() {
    ...
    /**
     * Inflates the sent postcards layout
     */
    ...
    /**
     * Updates display when a new postcard is sent
     */
    private fun listenForPostcards() {
        ...
        ref.addChildEventListener(object: ChildEventListener {
            override fun onChildAdded(p0: DataSnapshot, p1: String?) {
                ...
                // Ignore postcards that weren't sent by the user
                ...
                fragment_sent_mail_txt_placeholder?.visibility = View.GONE
            }
